...
<table border="1" cellspacing="0" width="100%">
    ...
    <c:forEach items="${applications}" var="application" varStatus="status">
        <tr align="center">
            ...
            <td>${application.stateReason}</td>
            <td><a href="${pageContext.request.contextPath}/selectUpdateAppServlet?id=${application.id}">修改</a> <a href="${pageContext.request.contextPath}/selectDeleteAppServlet?id=${application.id}">删除</a></td>>
        </tr>
